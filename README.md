...
Este reposório contem passos básicos para instalar o docker em um servidor Ubuntu e passos para a configuraçãpo dos serviços Apache Airflow, Apache Hop, Metabase, Postgres e posteriormente Apache Superset
